...
The backend of the application is built with NodeJS and ExpressJS and uses a MongoDB database to store the product and user data. The source code for the backend can be found at [https://github.com/LucasHunter1004/e-commerce-backend.git](https://github.com/LucasHunter1004/e-commerce-backend.git).
